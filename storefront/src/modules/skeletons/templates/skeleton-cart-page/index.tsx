        ...
        <div className="grid grid-cols-1">
          <div className="glass-panel rounded-3xl px-6 py-8">
            <div className="flex items-center justify-between">
              <div className="h-8 w-24 rounded-md bg-black/10 animate-pulse" />
              <div className="h-5 w-16 rounded-md bg-black/10 animate-pulse" />
            </div>
                  ...
                  <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex flex-col gap-2">
                        <div className="h-4 w-40 rounded-md bg-black/10 animate-pulse" />
            ...
            <div className="mt-6 h-12 w-full rounded-md bg-black/10 animate-pulse" />
          </div>
        </div>
      </div>
    </div>
